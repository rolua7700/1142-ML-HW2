...
def encode_features(df):
    ...
    df_encoded = pd.get_dummies(df, columns=['Sex', 'Embarked'], prefix={'Sex': 'Sex', 'Embarked': 'Embarked'})
...
def scale_features(df):
    ...
    df['Age'], df['Fare'] = scaler.fit_transform(df[['Age']]), scaler.fit_transform(df[['Fare']])
    df_scaled = df
    return df_scaled
